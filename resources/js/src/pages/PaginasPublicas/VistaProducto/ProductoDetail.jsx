...
export const ProductoDetail = ()=>{
    ...
    const {dataPublicacion,imagenes,loading} = UseProductoDetail();
        ...
        { dataPublicacion  &&
            <div className="product-container">
                ...
                <div className="features-container Responsive">
                    <h2 className="categorias Responsive" > Categoria: {dataPublicacion.producto[0].categoria.nombre}</h2>   
                    ...
                    <div className="buy-conditions ">
                        <h2 className="Stock"> 
                            <img src={Stock_icon} alt="disponibilidad " /> Stock Disponible: <strong>{dataPublicacion.stock}</strong>  </h2>
                        <h2 className="Envio "> 
                            <img src={shipping_icon} alt="envios" /> Envío a todo el pais  </h2>
                        <h2 className="garantia "> 
                            <img src={Shield_icon} alt="garantia" /> Compra Protegida <Link to="/InfoCompra">Ver Términos y Condiciones</Link> </h2>
                    </div>
                    <div className="container-button-agregar-carrito-detail">

                        <BotonComprar data={{imagen:dataPublicacion.imagenes[0].image_url,
                        ...
                        <BotonAgregarAlCarritoDetail data={{imagen:dataPublicacion.imagenes[0].image_url,
                                                titulo:dataPublicacion.titulo,
                                                price:dataPublicacion.precio,
                                                itemKey:dataPublicacion.publicacion_id,
                                                stock:dataPublicacion.stock
